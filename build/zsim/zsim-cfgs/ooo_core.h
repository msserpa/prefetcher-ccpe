...
zsim/src/ooo_core.h
@gaomy3832 gaomy3832 [all] Code style fixes. 247cd97 on Jun 26, 2015
@s5z
@gaomy3832
487 lines (409 sloc) 19.5 KB
/** $lic$
...
class OOOCore : public Core {
	...
	//Nehalem
        //CycleQueue<28> uopQueue;  // models issue queue 28 in nehalem, 64 in skylake
        
	//Skylake
	CycleQueue<64> uopQueue;  // models issue queue 28 in nehalem, 64 in skylake
